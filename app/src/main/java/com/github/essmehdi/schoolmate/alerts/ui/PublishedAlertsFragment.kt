...
class PublishedAlertsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_published_alerts, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment PublishedAlertsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PublishedAlertsFragment().apply {
